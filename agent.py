...
class FeudalNet(nn.Module):
    def __init__(self, observation_shape, action_space, d=256, k=16, c=10, channel_first=True):
        ...
        self.perception = Perception(observation_shape, d, channel_first)
    ...
    def forward(self, x, states, reset_value_grad=False):
        ...
        value_worker, action_logits, states_W = self.worker(z, sum_goal_W, states_W, reset_value_grad)

        return value_worker, value_manager, action_logits, g, nabla_dcos_t_minus_c, (states_W, states_M, ss)
